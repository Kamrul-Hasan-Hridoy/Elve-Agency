...
const About = () => {
  ...
  const [questionSubmitted, setQuestionSubmitted] = useState(false);
  const [openFaqId, setOpenFaqId] = useState(null);
  const [showVideo, setShowVideo] = useState(false); // Video popup state
  ...
  return (
    <>
        ...
        <div className="video-popup-overlay" onClick={closeVideoPopup}>
          <div className="video-popup" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="video-container">
              <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/-2RAq5o5pwc?si=1oT_x6Dr11DNnRrG" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
            <div className="video-fallback">
              <p>If the video doesn't load, you can watch it directly on 
                <a href="https://www.youtube.com/watch?v=-2RAq5o5pwc" target="_blank" rel="noopener noreferrer">
                  YouTube
                </a>
              </p>
            </div>
      ...
      <div className="learn-container">
        ...
        <div className="video-section">
          <div className="video-wrapper" onClick={openVideoPopup}>
            <img
              src={getImageUrl(aboutData.learnContainer.videoImage)}
              alt="About Us Video"
            />
